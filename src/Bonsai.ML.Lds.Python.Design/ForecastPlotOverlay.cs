...
[assembly: TypeVisualizer(typeof(Bonsai.ML.Lds.Python.Design.ForecastPlotOverlay),
    Target = typeof(MashupSource<Bonsai.ML.Lds.Python.Design.KinematicStateVisualizer, Bonsai.ML.Lds.Python.Design.ForecastVisualizer>))]

namespace Bonsai.ML.Lds.Python.Design
{
    /// <summary>
