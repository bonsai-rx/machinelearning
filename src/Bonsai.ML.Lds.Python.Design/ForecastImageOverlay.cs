...
[assembly: TypeVisualizer(typeof(Bonsai.ML.Lds.Python.Design.ForecastImageOverlay),
    Target = typeof(MashupSource<ImageMashupVisualizer, Bonsai.ML.Lds.Python.Design.ForecastVisualizer>))]
