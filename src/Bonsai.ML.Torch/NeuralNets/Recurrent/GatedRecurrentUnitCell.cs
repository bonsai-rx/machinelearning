...
/// <summary>
/// Represents an operator that creates a gated recurrent unit (GRU) cell.
/// </summary>
/// <remarks>
/// See <see href="https://pytorch.org/docs/stable/generated/torch.nn.GRUCell.html"/> for more information.
/// </remarks>
[Description("Creates a gated recurrent unit (GRU) cell module.")]
public class GatedRecurrentUnitCell
{
    /// <summary>
