...
/// <summary>
/// Creates a AlphaDropout module module.
/// </summary>
[Combinator]
[Description("Creates a AlphaDropout module module.")]
...
public class AlphaDropoutModule
{
    ...
    /// <summary>
    /// Generates an observable sequence that creates a AlphaDropout module.
    /// </summary>
