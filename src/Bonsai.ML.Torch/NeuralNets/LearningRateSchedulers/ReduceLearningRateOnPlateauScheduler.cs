...
/// <summary>
/// Creates a ReduceLearningRateOnPlateau scheduler.
/// </summary>
[Combinator]
[Description("Creates a ReduceLearningRateOnPlateau scheduler.")]
...
public class ReduceLearningRateOnPlateauScheduler
{
    ...
    /// <summary>
    /// Generates an observable sequence that creates a ReduceLearningRateOnPlateauScheduler.
    /// </summary>
