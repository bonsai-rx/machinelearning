...
/// <summary>
/// Creates a ASGD optimizer.
/// </summary>
[Combinator]
[Description("Creates a ASGD optimizer.")]
...
public class Asgd
{
    ...
    public double Lambd { get; set; } = 0.0001D;
    ...
    /// <summary>
    /// Generates an observable sequence that creates a ASGDOptimizer.
    /// </summary>
