...
{
    /// <summary>
    /// The inputsize parameter for the GRU module.
    /// </summary>
    [Description("The inputsize parameter for the GRU module")]
    public long InputSize { get; set; }

    /// <summary>
    /// The hiddensize parameter for the GRU module.
    /// </summary>
    [Description("The hiddensize parameter for the GRU module")]
    public long HiddenSize { get; set; }

    /// <summary>
    /// The numlayers parameter for the GRU module.
    /// </summary>
    [Description("The numlayers parameter for the GRU module")]
    ...
    /// <summary>
    /// The batchfirst parameter for the GRU module.
    /// </summary>
    [Description("The batchfirst parameter for the GRU module")]
    ...
    /// </summary>
    [Description("The bidirectional parameter for the GRU module")]
