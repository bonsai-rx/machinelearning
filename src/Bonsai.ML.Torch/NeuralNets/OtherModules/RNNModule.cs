...
{
    /// <summary>
    /// The inputsize parameter for the RNN module.
    /// </summary>
    [Description("The inputsize parameter for the RNN module")]
    public long InputSize { get; set; }

    /// <summary>
    /// The hiddensize parameter for the RNN module.
    /// </summary>
    [Description("The hiddensize parameter for the RNN module")]
    public long HiddenSize { get; set; }

    /// <summary>
    /// The numlayers parameter for the RNN module.
    /// </summary>
    [Description("The numlayers parameter for the RNN module")]
    public long NumLayers { get; set; } = 1;

    /// <summary>
    /// The nonlinearity parameter for the RNN module.
    /// </summary>
    [Description("The nonlinearity parameter for the RNN module")]
    ...
    /// <summary>
    /// The batchfirst parameter for the RNN module.
    /// </summary>
    [Description("The batchfirst parameter for the RNN module")]
    ...
    /// </summary>
    [Description("The bidirectional parameter for the RNN module")]
