...
namespace Bonsai.ML.HiddenMarkovModels.Observations
{
    ...
    public class GaussianObservationClusters
    {
        /// <summary>
        ...
        public IObservable<GaussianObservationClusters> Process(IObservable<PyObject> source)
        {
            return Observable.Select(source, pyObject =>
            {
                ...
                return new GaussianObservationClusters
                {
                    Means = meansPyObj,
