...
namespace Bonsai.ML.LinearDynamicalSystems.LinearRegression
{
    ...
    public class KFModelParameters
    {
        ...
        /// </summary>
        [YamlMember(Alias="likelihood_precision_coef")]
        ...
        /// </summary>
        [YamlMember(Alias="prior_precision_coef")]
        ...
        public double[] Mn
        {
            ...
            {
                _mn = value;
                if (_mn.Length == 0) _mnString = "None";
                else
                {
                    _mnString = NumpyHelper.NumpyParser.ParseArray(_mn.ToArray());
                }
            }
        }
