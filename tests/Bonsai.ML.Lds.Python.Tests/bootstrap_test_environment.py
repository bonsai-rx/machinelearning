...
install(venv_path, ["--no-cache-dir", "pandas"])
install(venv_path, ["--no-cache-dir", "lds_python@git+https://github.com/ncguilbeault/lds_python@dc7a2e02892033734746bc0615dc294f5b43f672"])
